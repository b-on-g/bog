...
declare namespace $.$$ {
    class $bog_feedback2_form extends $.$bog_feedback2_form {
        ...
        submit_title(): "Update feedback" | "Send feedback";
        submit(): void;
        tools(): $.$giper_baza_status[];
        body(): $.$mol_status[] | ($.$mol_string | $.$mol_text | $.$mol_textarea | $mol_button_major | $.$mol_section)[];
        all_lords(): any;
        entry_rows(): any;
...
declare namespace $ {
	...
	type $bog_feedback2_form__feedback_id_bog_feedback2_demo_1 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_feedback2_form['feedback_id'] >
	>
	export class $bog_feedback2_demo extends $mol_example_small {
		Theme( ): $mol_theme_auto
		Preview( ): $bog_feedback2_form
		title( ): string
		plugins( ): readonly(any)[]
		sub( ): readonly(any)[]
		tags( ): readonly(any)[]
...
//# sourceMappingURL=demo.view.tree.d.ts.map
declare namespace $.$$ {
    class $bog_feedback2_demo extends $.$bog_feedback2_demo {
    }
}
