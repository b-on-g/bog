...
declare namespace $.$$ {
    class $bog_feedback_form extends $.$bog_feedback_form {
        ...
        entry_text(next?: string): string;
        contact(next?: string): string;
        body(): ($.$mol_string | $.$mol_text | $.$mol_textarea | $.$mol_section | $mol_bar)[];
...
declare namespace $ {
	...
	type $bog_feedback_form__topic_bog_feedback_demo_1 = $mol_type_enforce<
		ReturnType< $bog_feedback_demo['topic'] >
		,
