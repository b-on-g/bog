    ...
    (function ($$) {
        ...
        class $bog_qr_demo extends $.$bog_qr_demo {
            ...
            download(next) {
                if (next === undefined)
                    return null;
                const svg = this.Preview().dom_node();
        ...
        __decorate([
            $mol_mem
        ], $bog_qr_demo.prototype, "preset_stops", null);
        __decorate([
            $mol_mem
        ], $bog_qr_demo.prototype, "icon_data", null);
        __decorate([
            $mol_mem
        ], $bog_qr_demo.prototype, "preview_center", null);
        __decorate([
            $mol_mem
        ], $bog_qr_demo.prototype, "preview_ec", null);
        __decorate([
            $mol_mem
        ], $bog_qr_demo.prototype, "Icon_image", null);
        $$.$bog_qr_demo = $bog_qr_demo;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    ...
    $.$bog_feedback_entry = $bog_feedback_entry;
})($ || ($ = {}));
...
;
	($.$bog_feedback_form) = class $bog_feedback_form extends ($.$mol_page) {
		...
		Entries(){
			const obj = new this.$.$mol_section();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_feedback_form_Entries_title")));
...
;
	($.$bog_feedback_demo) = class $bog_feedback_demo extends ($.$mol_example_small) {
		Preview(){
	...
	($mol_mem(($.$bog_feedback_demo.prototype), "Preview"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        $$.$bog_feedback_demo = $bog_feedback_demo;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	...
	($mol_mem(($.$bog_feedback2_form.prototype), "Status"));
...
;
	($.$bog_feedback2_demo) = class $bog_feedback2_demo extends ($.$mol_example_small) {
		Theme(){
			const obj = new this.$.$mol_theme_auto();
			return obj;
		}
	...
	($mol_mem(($.$bog_feedback2_demo.prototype), "Theme"));
	($mol_mem(($.$bog_feedback2_demo.prototype), "Preview"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        $$.$bog_feedback2_demo = $bog_feedback2_demo;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));

;
	($.$bog_demo) = class $bog_demo extends ($.$mol_app_demo) {
		Status(){
			const obj = new this.$.$giper_baza_status();
			return obj;
		}
		menu_title(){
			return "BOG Components";
		}
		source_prefix(){
			return "https://github.com/b-on-g/bog/tree/master/";
		}
		sources_uri(){
			return "https://github.com/b-on-g/bog/";
		}
		tools(){
			return [...(super.tools()), (this.Status())];
		}
	};
	($mol_mem(($.$bog_demo.prototype), "Status"));
