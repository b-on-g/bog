...
;
	($.$bog_demo_sum) = class $bog_demo_sum extends ($.$mol_app_quine) {
		a(next){
			if(next !== undefined) return next;
			return 1;
		}
		...
		paths(){
			return ["../sum.view.tree", "../sum.view.ts"];
		}
		body(){
			return [
				(this.A()), 
	...
	($mol_mem(($.$bog_demo_sum.prototype), "a"));
	($mol_mem(($.$bog_demo_sum.prototype), "A"));
	($mol_mem(($.$bog_demo_sum.prototype), "b"));
	($mol_mem(($.$bog_demo_sum.prototype), "B"));
	($mol_mem(($.$bog_demo_sum.prototype), "Result"));
...
(function ($) {
    ...
    (function ($$) {
        class $bog_demo_sum extends $.$bog_demo_sum {
            result() {
                return `${this.a().toFixed(2)} + ${this.b()} = ${this.a() + this.b()}`;
            }
        }
        __decorate([
            $mol_mem
        ], $bog_demo_sum.prototype, "result", null);
        $$.$bog_demo_sum = $bog_demo_sum;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
