...
Один и тот же сценарий, одно и то же железо. [Исходники обеих демок](https://github.com/nin-jin/sierpinski).

А вот стандартный [js-framework-benchmark](https://nin-jin.github.io/js-framework-benchmark/webdriver-ts-results/table.html), где Карловский включил $mol — виртуальный рендеринг рвёт всех в щепки, потому что компонентов вне вьюпорта просто не существует.
