...
declare namespace $.$$ {
    class $giper_baza_flex_field extends $.$giper_baza_flex_field {
        dict_pawn(): $giper_baza_dict;
        Sub(): $.$mol_expander | $.$mol_textarea | $.$mol_select | $.$mol_drop | $.$mol_number | $.$mol_date | $mol_check_box | $mol_bar;
...
declare namespace $.$$ {
    class $bog_notebookllm_app extends $.$bog_notebookllm_app {
        store(): $bog_notebookllm_store;
        private _engine;
        private _engine_loading;
        engine(): any;
        engine_start(): void;
        model_status_text(next?: string): string;
        auto(): void;
        notebooks(): readonly $bog_notebookllm_notebook[];
        current_notebook(): $bog_notebookllm_notebook | null;
        notebook_add(): void;
        notebook_rows(): $mol_row[];
        notebook_title(index: number): string;
        notebook_select(index: number): void;
        notebook_delete(index: number): void;
        current_docs(): readonly $bog_notebookllm_doc[];
        doc_rows(): $mol_row[];
        doc_name(index: number): string;
        doc_count_text(): string;
        doc_upload_click(): void;
        add_document(name: string, content: string): void;
        doc_remove(index: number): void;
        retrieve(query: string, top_k?: number): string[];
        ...
        prompt_text(next?: string): string;
        prompt_submit(): void;
        generate(eng: any, messages: {
            role: string;
            content: string;
        }[], nb: $bog_notebookllm_notebook): void;
        reset(): void;
        sources_info(): string;
    }
}
...
declare namespace $ {
    const $bog_notebookllm_doc_base: Omit<typeof $giper_baza_flex_subj, "prototype"> & {
        new (...args: any[]): $mol_type_override<$giper_baza_flex_subj, {
            readonly Content: (auto?: any) => $giper_baza_atom_text | null;
            readonly Chunks: (auto?: any) => $giper_baza_list_str | null;
            readonly Embeddings_json: (auto?: any) => $giper_baza_atom_text | null;
        }>;
        path: string;
    } & {
        schema: {
            ...
            readonly Chunks: typeof $giper_baza_list_str;
            readonly Embeddings_json: typeof $giper_baza_atom_text;
        };
    };
    export class $bog_notebookllm_doc extends $bog_notebookllm_doc_base {
        embeddings(): number[][];
        embeddings_set(emb: number[][]): void;
    }
    const $bog_notebookllm_message_base: Omit<typeof $giper_baza_flex_subj, "prototype"> & {
        new (...args: any[]): $mol_type_override<$giper_baza_flex_subj, {
    ...
    export class $bog_notebookllm_message extends $bog_notebookllm_message_base {
    }
    const $bog_notebookllm_notebook_base: Omit<typeof $giper_baza_flex_subj, "prototype"> & {
        new (...args: any[]): $mol_type_override<$giper_baza_flex_subj, {
            readonly Docs: (auto?: any) => {
                remote_list(next?: readonly $bog_notebookllm_doc[] | undefined): readonly $bog_notebookllm_doc[];
                remote_add(item: $bog_notebookllm_doc): void;
                make(config: null | number | $giper_baza_rank_preset | $giper_baza_land): $bog_notebookllm_doc;
                items(next?: readonly ($giper_baza_link | null)[] | undefined): readonly ($giper_baza_link | null)[];
                items_vary(next?: readonly $giper_baza_vary_type[], tag?: keyof typeof $giper_baza_unit_sand_tag): readonly $giper_baza_vary_type[];
                splice(next: readonly $giper_baza_vary_type[], from?: number, to?: number, tag?: keyof typeof $giper_baza_unit_sand_tag): void;
                find(vary: $giper_baza_vary_type): $giper_baza_unit_sand | null;
            ...
            readonly Messages: (auto?: any) => {
                remote_list(next?: readonly $bog_notebookllm_message[] | undefined): readonly $bog_notebookllm_message[];
                remote_add(item: $bog_notebookllm_message): void;
                make(config: null | number | $giper_baza_rank_preset | $giper_baza_land): $bog_notebookllm_message;
                items(next?: readonly ($giper_baza_link | null)[] | undefined): readonly ($giper_baza_link | null)[];
                items_vary(next?: readonly $giper_baza_vary_type[], tag?: keyof typeof $giper_baza_unit_sand_tag): readonly $giper_baza_vary_type[];
                splice(next: readonly $giper_baza_vary_type[], from?: number, to?: number, tag?: keyof typeof $giper_baza_unit_sand_tag): void;
                find(vary: $giper_baza_vary_type): $giper_baza_unit_sand | null;
            ...
            readonly Digest: (auto?: any) => $giper_baza_atom_text | null;
            readonly Dialog_title: (auto?: any) => $giper_baza_atom_text | null;
        }>;
        path: string;
    } & {
        schema: {
            ...
            readonly Digest: typeof $giper_baza_atom_text;
            readonly Dialog_title: typeof $giper_baza_atom_text;
        };
    };
    export class $bog_notebookllm_notebook extends $bog_notebookllm_notebook_base {
    }
    const $bog_notebookllm_store_base: Omit<typeof $giper_baza_flex_subj, "prototype"> & {
        new (...args: any[]): $mol_type_override<$giper_baza_flex_subj, {
            readonly Notebooks: (auto?: any) => {
                remote_list(next?: readonly $bog_notebookllm_notebook[] | undefined): readonly $bog_notebookllm_notebook[];
                remote_add(item: $bog_notebookllm_notebook): void;
                make(config: null | number | $giper_baza_rank_preset | $giper_baza_land): $bog_notebookllm_notebook;
                items(next?: readonly ($giper_baza_link | null)[] | undefined): readonly ($giper_baza_link | null)[];
                items_vary(next?: readonly $giper_baza_vary_type[], tag?: keyof typeof $giper_baza_unit_sand_tag): readonly $giper_baza_vary_type[];
                splice(next: readonly $giper_baza_vary_type[], from?: number, to?: number, tag?: keyof typeof $giper_baza_unit_sand_tag): void;
                find(vary: $giper_baza_vary_type): $giper_baza_unit_sand | null;
            ...
            readonly Current_notebook: (auto?: any) => {
                Value: Value;
                remote(next?: $bog_notebookllm_notebook | null | undefined): $bog_notebookllm_notebook | null;
                remote_of(peer: $giper_baza_link | null, next?: $bog_notebookllm_notebook | null | undefined): $bog_notebookllm_notebook | null;
                ensure(config?: null | $giper_baza_rank_preset | $giper_baza_land): $bog_notebookllm_notebook | null;
                ensure_of(peer: $giper_baza_link | null, config?: null | $giper_baza_rank_preset | $giper_baza_land): $bog_notebookllm_notebook | null;
                ensure_here(peer: $giper_baza_link | null): void;
                ensure_area(peer: $giper_baza_link | null, land: $giper_baza_land): void;
                ensure_lord(peer: $giper_baza_link | null, preset: $giper_baza_rank_preset): void;
                remote_ensure(preset?: $giper_baza_rank_preset): $bog_notebookllm_notebook | null;
                local_ensure(): $bog_notebookllm_notebook | null;
                val(next?: $giper_baza_link | null | undefined): $giper_baza_link | null;
                val_of(peer: $giper_baza_link | null, next?: $giper_baza_link | null | undefined): $giper_baza_link | null;
                pick_unit(peer: $giper_baza_link | null): $giper_baza_unit_sand | undefined;
                vary(next?: $giper_baza_vary_type): $giper_baza_vary_type;
        ...
        schema: {
            ...
            readonly Current_notebook: {
                new (): {
                    Value: () => typeof $bog_notebookllm_notebook;
                    remote(next?: $bog_notebookllm_notebook | null | undefined): $bog_notebookllm_notebook | null;
                    remote_of(peer: $giper_baza_link | null, next?: $bog_notebookllm_notebook | null | undefined): $bog_notebookllm_notebook | null;
                    ensure(config?: null | $giper_baza_rank_preset | $giper_baza_land): $bog_notebookllm_notebook | null;
                    ensure_of(peer: $giper_baza_link | null, config?: null | $giper_baza_rank_preset | $giper_baza_land): $bog_notebookllm_notebook | null;
    ...
    export class $bog_notebookllm_store extends $bog_notebookllm_store_base {
    }
    export {};
}
